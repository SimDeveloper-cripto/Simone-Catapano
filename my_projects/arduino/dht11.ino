...
* Esso sfrutta un display LCD_I2C ed un modulo sensore di temperatura e umidità chiamato DHT11. 
* Il sensore registra i dati di temperatura e umidità che rileva e il display li mostra a video.
*/
